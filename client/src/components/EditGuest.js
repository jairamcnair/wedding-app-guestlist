...
// this code is running twice - how do i get it to run once? I think that's why my checkboxes wont work
// solution: the checkboxes didn't work because of the code that shows a checked or unchecked checkbox when the page loads

// first see if it is the modal
const EditGuest = ({ guest }) => {
  ...
  return (
    <Fragment>
      <button type="button" className="btn btn-primary" data-toggle="modal" data-target={`#id${guest.guest_id}`}>
        {guest.guest_name}
      </button>
                ...
                <div className="modal-body">
                  ...
                  <div className="w-100 p-3">
                      ...
                      <div className="input-group-prepend">
                        ...
                        <input type="number" className="form-control w-75" value={guest_count} onChange={(e) => {setGuestCount(e.target.checked);}}/>
                      </div>

                      <div className="input-group-prepend">
                        <label className="input-group-text w-25"> Need Hotel </label>
                        <input type="checkbox"  className="form-control w-75" value={guest_needhotel} onChange={(e) => {setGuestNeedhotel(e.target.checked); showCheckboxState(e.target.value)}}/>
                      </div>
                      ...
                      <div className="input-group-prepend">
                        ...
                        <input type="checkbox" className="form-control w-75" value={guest_rsvp} onChange={(e) => {setGuestRsvp(e.target.checked);}}/>
                      </div>
                  ...
                  <div className="d-flex mt-3 w-100">
                    <div className="input-group-prepend w-100">
                      ...
                      <input
                        ...
                        className="custon-control-input w-75"
                        value={guest_rsvp}
